package com.vcare.bannerindicator;
...
import com.vcare.bannerindicator.adapter.ImageAdapter;
import com.vcare.bannerindicator.adapter.ImageTitleAdapter;
import com.vcare.bannerindicator.adapter.ImageTitleNumAdapter;
import com.vcare.bannerindicator.adapter.MultipleTypesAdapter;
...
//                    adapter.updateData(DataBean.getTestData2());
    ...
    @OnClick( {R.id.style_image, R.id.style_image_title, R.id.style_image_title_num, R.id.style_multiple,
            R.id.style_net_image, R.id.change_indicator})
